      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900">
            Heaven for <span className="bg-blue-600 text-white px-3 py-1 rounded-md shadow-md">SOLO Travelers</span>
          </h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 relative">
          ...
          <div className="relative group">
            <div className="rounded-xl p-2 bg-white shadow-lg transform group-hover:scale-105 transition-transform duration-300">
              <Image
                src="/jungle.jpeg?height=250&width=300"
        ...
        <div className="flex justify-center mt-12">
          <Link
            href="#"
            className="px-8 py-4 bg-blue-600 text-white text-lg font-semibold rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg transition-all duration-300"
          >
            Download Now
          </Link>
        </div>
